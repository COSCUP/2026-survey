...
const en: Copy = {
  ...
  pulse: { eyebrow: "01 · REGISTRATION PULSE", title: "Waves that keep building from the registration desk", description: "From the July 17 opening through August 9, follow how preregistrations build in six-hour intervals on their way to the event.", firstMinute: "preregistered in the first minute", heat: "Interest formed as soon as the desk opened", minute1: "1 minute", minute5: "5 minutes", minute30: "30 minutes", hour2: "2 hours", note: "Figures show the registration desk total at each time point.", timelineTitle: "Every six hours, the shoreline grows", timelineAdded: "New preregistrations in this interval", timelineCumulative: "Cumulative preregistrants", timelineStart: "Starting point: {time}", timelineCurrent: "{count} preregistrants so far", timelineEnd: "Aug 9 finish", timelineNumbers: "Show all six-hour figures", timelineAddedValue: "+{count}", timelineCumulativeValue: "{count} cumulative", timelineAria: "New preregistrations by six-hour interval and the cumulative curve, ending on August 9." },
...
const ja: Copy = {
  ...
  pulse: { eyebrow: "01 · REGISTRATION PULSE", title: "受付開始後、積み重なる波", description: "7 月 17 日の受付開始から 8 月 9 日まで、6 時間ごとに事前登録が会場へ向かう人の流れになる様子を見ていきます。", firstMinute: "最初の 1 分間に事前登録", heat: "受付開始と同時に関心が高まりました", minute1: "1 分", minute5: "5 分", minute30: "30 分", hour2: "2 時間", note: "各時点の受付での累計登録数です。", timelineTitle: "6 時間ごとに、海岸線が少しずつ広がる", timelineAdded: "この時間帯の新規登録", timelineCumulative: "累計事前登録者", timelineStart: "開始：{time}", timelineCurrent: "現在 {count} 人", timelineEnd: "8/9 終点", timelineNumbers: "6 時間ごとの全数値を表示", timelineAddedValue: "+{count} 人", timelineCumulativeValue: "累計 {count} 人", timelineAria: "6 時間ごとの新規登録と累計事前登録者の曲線。右端は 8 月 9 日の終点です。" },
...
const ko: Copy = {
  ...
  pulse: { eyebrow: "01 · REGISTRATION PULSE", title: "등록 창구가 열린 뒤 계속 쌓이는 파도", description: "7월 17일 등록 창구가 열린 때부터 8월 9일까지, 여섯 시간 간격으로 사전 등록이 행사장으로 향하는 흐름이 되는 모습을 살펴봅니다.", firstMinute: "첫 1분 내 사전 등록", heat: "등록 창구가 열리자마자 관심이 이어졌습니다", minute1: "1분", minute5: "5분", minute30: "30분", hour2: "2시간", note: "각 시점의 등록 창구 누적 수치입니다.", timelineTitle: "여섯 시간마다 조금씩 자라는 해안선", timelineAdded: "이 시간대의 신규 사전 등록", timelineCumulative: "누적 사전 등록자", timelineStart: "시작: {time}", timelineCurrent: "현재 누적 {count}명", timelineEnd: "8/9 마감", timelineNumbers: "6시간 단위 전체 수치 보기", timelineAddedValue: "+{count}명", timelineCumulativeValue: "누적 {count}명", timelineAria: "여섯 시간 단위 신규 사전 등록과 누적 곡선입니다. 오른쪽 끝은 8월 9일 마감입니다." },
