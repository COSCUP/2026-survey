...
const zhHant = {
  ...
  persona: {
    ...
    description: "以同一群報名者重新計算各題分布；複選題顯示選擇人次，數字可展開查看完整項目。",
    countLabel: "這個群體",
    countUnit: "人",
    back: "← 回到報名總覽",
    switcher: "切換 Persona",
...
const en: Copy = {
  ...
  persona: { exploreRole: "View this Persona ↗", exploreTrack: "View this track Persona ↗", eyebrow: "PERSONA LENS · 2026", roleTitle: "Who are the {name}?", trackTitle: "Who is interested in “{name}”?", description: "Each distribution is recalculated for the same cohort. Multiple-choice figures count selections, with complete values available to expand.", countLabel: "Cohort size", countUnit: "people", back: "← Back to overview", switcher: "Switch Persona", schedule: "Open this track schedule ↗", scheduleFallback: "Open the full schedule ↗", unavailable: "The latest source has not generated Persona statistics yet. Update and redeploy Apps Script first.", age: "Age distribution", roles: "Overlapping open-source roles", entry: "Paths into open source", os: "Everyday operating systems", licenses: "License preferences", workAI: "AI used at work", dailyAI: "AI used in daily life", motivations: "What they hope to gain", tracks: "Other tracks they follow", expandUnit: "complete items" },
...
const ko: Copy = {
  ...
  persona: { exploreRole: "이 Persona 보기 ↗", exploreTrack: "이 트랙 Persona 보기 ↗", eyebrow: "PERSONA LENS · 2026", roleTitle: "{name}은 어떤 사람들일까요?", trackTitle: "‘{name}’에 관심 있는 사람들은?", description: "같은 등록자 그룹을 기준으로 각 응답 분포를 다시 계산합니다. 복수 선택은 선택 횟수이며 전체 항목을 펼칠 수 있습니다.", countLabel: "그룹 규모", countUnit: "명", back: "← 전체 개요로", switcher: "Persona 전환", schedule: "이 트랙 일정 보기 ↗", scheduleFallback: "전체 일정 보기 ↗", unavailable: "최신 데이터에 Persona 통계가 없습니다. Apps Script를 업데이트하고 다시 배포하세요.", age: "연령 분포", roles: "겹치는 오픈소스 역할", entry: "오픈소스 입문 경로", os: "일상 운영체제", licenses: "라이선스 선호", workAI: "업무용 AI", dailyAI: "일상용 AI", motivations: "행사에서 기대하는 것", tracks: "함께 관심 있는 트랙", expandUnit: "개 전체 항목" },
