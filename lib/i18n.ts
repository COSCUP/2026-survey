...
const zhHant = {
  ...
  pulse: {
    ...
    title: "票亭開放後的一波波浪潮們",
    description: "7 月 17 日晚間 20:00 票亭開放後，最密集的登錄出現在第一分鐘。",
...
const en: Copy = {
  ...
  pulse: { eyebrow: "01 · REGISTRATION PULSE", title: "Waves from the registration desk", description: "When the registration desk opened at 20:00 on July 17, the first minute brought the strongest rush.", firstMinute: "preregistered in the first minute", heat: "Interest formed as soon as the desk opened", minute1: "1 minute", minute5: "5 minutes", minute30: "30 minutes", hour2: "2 hours", note: "Figures show the registration desk total at each time point." },
...
const ja: Copy = {
  ...
  pulse: { eyebrow: "01 · REGISTRATION PULSE", title: "受付が開いたあとの、次々と来る波", description: "7 月 17 日 20:00 に受付が開くと、最初の 1 分間に登録が最も集中しました。", firstMinute: "最初の 1 分間に事前登録", heat: "受付開始と同時に関心が高まりました", minute1: "1 分", minute5: "5 分", minute30: "30 分", hour2: "2 時間", note: "各時点の受付での累計登録数です。" },
...
const ko: Copy = {
  ...
  pulse: { eyebrow: "01 · REGISTRATION PULSE", title: "등록 창구가 열린 뒤 이어진 파도들", description: "7월 17일 20:00 등록 창구가 열린 뒤, 첫 1분에 사전 등록이 가장 밀집했습니다.", firstMinute: "첫 1분 내 사전 등록", heat: "등록 창구가 열리자마자 관심이 이어졌습니다", minute1: "1분", minute5: "5분", minute30: "30분", hour2: "2시간", note: "각 시점의 등록 창구 누적 수치입니다." },
