...
const zhHant = {
  ...
  persona: {
    ...
    tracks: "也感興趣的議程軌",
    comparisonNote: "粗條為這個 Persona，淺色細條為全體報名者；比例皆以各自群體人數為分母。",
    cohortLegend: "這個 Persona：人數 · 群體占比",
    populationLegend: "全體報名者：人數 · 全體占比",
    cohortShort: "這群",
    populationShort: "全體",
...
const en: Copy = {
  ...
  persona: { exploreRole: "View this Persona ↗", exploreTrack: "View this track Persona ↗", eyebrow: "PERSONA LENS · 2026", roleTitle: "Who are the {name}?", trackTitle: "Who is interested in “{name}”?", description: "Each distribution is recalculated for the same cohort and compared with all registrants. Multiple-choice figures count selections, with complete values available to expand.", countLabel: "Cohort size", countUnit: "people", back: "← Back to overview", switcher: "Switch Persona", schedule: "Open this track schedule ↗", scheduleFallback: "Open the full schedule ↗", unavailable: "The latest source has not generated Persona statistics yet. Update and redeploy Apps Script first.", age: "Age distribution", roles: "Overlapping open-source roles", entry: "Paths into open source", os: "Everyday operating systems", licenses: "License preferences", workAI: "AI used at work", dailyAI: "AI used in daily life", motivations: "What they hope to gain", tracks: "Other tracks they follow", comparisonNote: "Thick bars show this Persona; thin pale bars show all registrants. Each percentage uses its own group as the denominator.", cohortLegend: "This Persona: people · cohort share", populationLegend: "All registrants: people · overall share", cohortShort: "Persona", populationShort: "All", rankPath: "All #{from} → Persona #{to}", rankUp: "Up {count} places", rankDown: "Down {count} places", rankSame: "Same rank", comparisonAria: "{label}: this Persona {cohortValue} people, {cohortRate}; all registrants {populationValue} people, {populationRate}. {rank}", expandUnit: "complete items" },
...
const ja: Copy = {
  ...
  persona: { exploreRole: "この Persona を見る ↗", exploreTrack: "このトラックの Persona ↗", eyebrow: "PERSONA LENS · 2026", roleTitle: "{name} はどんな人たち？", trackTitle: "「{name}」に関心を持つ人たちは？", description: "同じ登録者グループで各回答分布を再集計し、登録者全体と比較します。複数選択は選択数で、全項目を展開できます。", countLabel: "グループ人数", countUnit: "人", back: "← 概要へ戻る", switcher: "Persona を切り替え", schedule: "このトラックの日程を見る ↗", scheduleFallback: "全日程を見る ↗", unavailable: "最新データに Persona 集計がありません。Apps Script を更新して再デプロイしてください。", age: "年齢分布", roles: "重複する役割", entry: "オープンソースへの入口", os: "日常の OS", licenses: "ライセンス選好", workAI: "仕事で使う AI", dailyAI: "日常で使う AI", motivations: "参加への期待", tracks: "ほかに関心のあるトラック", comparisonNote: "太いバーはこの Persona、薄い淡色バーは登録者全体です。割合はそれぞれのグループ人数を分母にしています。", cohortLegend: "この Persona：人数・グループ比率", populationLegend: "登録者全体：人数・全体比率", cohortShort: "Persona", populationShort: "全体", rankPath: "全体 #{from} → Persona #{to}", rankUp: "{count} 位上昇", rankDown: "{count} 位下降", rankSame: "同順位", comparisonAria: "{label}：この Persona は {cohortValue} 人、{cohortRate}。登録者全体は {populationValue} 人、{populationRate}。{rank}", expandUnit: "件の全データ" },
...
const ko: Copy = {
  ...
  persona: { exploreRole: "이 Persona 보기 ↗", exploreTrack: "이 트랙 Persona 보기 ↗", eyebrow: "PERSONA LENS · 2026", roleTitle: "{name}은 어떤 사람들일까요?", trackTitle: "‘{name}’에 관심 있는 사람들은?", description: "같은 등록자 그룹을 기준으로 각 응답 분포를 다시 계산하고 전체 등록자와 비교합니다. 복수 선택은 선택 횟수이며 전체 항목을 펼칠 수 있습니다.", countLabel: "그룹 규모", countUnit: "명", back: "← 전체 개요로", switcher: "Persona 전환", schedule: "이 트랙 일정 보기 ↗", scheduleFallback: "전체 일정 보기 ↗", unavailable: "최신 데이터에 Persona 통계가 없습니다. Apps Script를 업데이트하고 다시 배포하세요.", age: "연령 분포", roles: "겹치는 오픈소스 역할", entry: "오픈소스 입문 경로", os: "일상 운영체제", licenses: "라이선스 선호", workAI: "업무용 AI", dailyAI: "일상용 AI", motivations: "행사에서 기대하는 것", tracks: "함께 관심 있는 트랙", comparisonNote: "굵은 막대는 이 Persona, 옅은 가는 막대는 전체 등록자입니다. 비율은 각 그룹 인원을 분모로 계산합니다.", cohortLegend: "이 Persona: 인원 · 그룹 비율", populationLegend: "전체 등록자: 인원 · 전체 비율", cohortShort: "Persona", populationShort: "전체", rankPath: "전체 #{from} → Persona #{to}", rankUp: "{count}위 상승", rankDown: "{count}위 하락", rankSame: "동일 순위", comparisonAria: "{label}: 이 Persona {cohortValue}명, {cohortRate}; 전체 등록자 {populationValue}명, {populationRate}. {rank}", expandUnit: "개 전체 항목" },
